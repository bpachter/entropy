...
export const atomsBlocks: AtomsBlock[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Two months before he wrote it, in March, Einstein had already sent off a stranger paper — and, by his own later judgment, a more revolutionary one. Light itself, he proposed, is not the smooth wave everyone assumed but arrives in the same discrete quanta Max Planck had reluctantly invented five years earlier to keep an oven from radiating infinite ultraviolet. Einstein used the idea to explain the photoelectric effect, and it is that paper the Nobel committee cited in 1921 — not this one, and not relativity.',
    ],
    sidenote: {
